# Hey, I'm Tezz 👋
### Automation Engineer | Python & Next.js Developer

I build automation solutions with Python and Next.js to make enterprise systems smarter and more efficient. When I'm not streamlining workflows in ManageEngine, I'm learning how to build the next great web app.

> 🦻 Fun Fact: My hearing aids stream calls and Spotify straight to my ears. I'm passionate about technology that **empowers and includes everyone.**
...
- 🗣️ Building Live Caption Saver — real-time accessibility transcription tool
- 🔐 Building a Password Generator with entropy analysis & strength scoring
- 🤖 Automating enterprise workflows with ManageEngine & Python
- 🧪 Setting up CI/CD pipelines with GitHub Actions & Azure DevOps
- 📚 Expanding into full-stack development with Next.js
...
[![ServiceNow](https://img.shields.io/badge/ServiceNow-003B74?logo=ServiceNow&logoColor=white)](https://learning.servicenow.com/lxp?id=nl_public&user=letezzkhan)
[![Credly](https://img.shields.io/badge/Credly-FF6B00?logo=credly&logoColor=white)](https://www.credly.com/users/le-tezz-khan)
